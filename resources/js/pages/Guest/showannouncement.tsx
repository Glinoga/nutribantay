                    ...
                    <div className="mx-auto max-w-4xl">
                        ...
                        <div className="mt-16 relative overflow-hidden rounded-2xl bg-gradient-to-br from-[var(--primary)] to-teal-900 p-8 text-center">
                            ...
                            <div className="relative">
                                <h3 className="mb-2 text-xl font-semibold text-white">Stay Connected</h3>
                                ...
                                <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
                                    ...
                                    <Link href={route('guest.contact')}>
                                        <Button className="cursor-pointer rounded-full bg-white text-[var(--primary)] hover:bg-white/90">
                                            Contact Us
                                        </Button>
                                    </Link>
                                </div>
                                        ...
                                        <AnnouncementCard
                                            ...
                                            renderActions={() => (
                                                <Link href={route('guest.announcements.show', { announcement: related.slug })}>
                                                    <Button
                                                        className="cursor-pointer rounded-full border border-[var(--border-muted)] bg-white px-4 py-2 text-sm font-medium text-[var(--primary)] shadow-sm transition-all hover:border-[var(--primary)] hover:bg-[var(--primary)] hover:text-white dark:bg-[var(--bg-light)]"
                                                        size="sm"
                                                    >
                                                        Read More
                                                    </Button>
