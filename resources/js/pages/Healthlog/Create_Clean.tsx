...
export default function Create({
    ...
    return (
        ...
        >
            ...
            <div className="relative min-h-screen overflow-x-hidden bg-gradient-to-br from-teal-50 via-white to-cyan-50">
                    ...
                    <form onSubmit={submit} className="fade-in-up space-y-6" style={{ animationDelay: '0.2s' }}>
                                        ...
                                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                            ...
                                            {selectedRecord.ruf && (
                                                <div className="rounded-md bg-gray-50 p-3">
                                                    ...
                                                    <p className="mt-1 font-semibold text-gray-900">{selectedRecord.ruf}</p>
                                                </div>
                                            )}
                                            {selectedRecord.rusf && (
                                                <div className="rounded-md bg-gray-50 p-3">
                        ...
                        <div className="form-section rounded-xl border-0 bg-white shadow-md transition-all hover:shadow-lg">
                            ...
                            <div className="grid grid-cols-1 gap-4 p-6 sm:grid-cols-2">
                                ...
                                <div>
                                    <Label htmlFor="ruf" className="text-gray-700">
