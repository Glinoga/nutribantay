                        ...
                        {announcements.map((announcement) => (
                            <div key={announcement.id} className="card-hover group relative overflow-hidden rounded-2xl bg-white shadow-sm">
                                ...
                                <div className="absolute top-0 right-0 left-0 p-6">
                                    <span
                                        className={`inline-block rounded-full ${getCategoryColorClass(announcement.categoryColor)} px-3 py-1 text-xs font-medium text-white`}
                                    >
                                ...
                                <div className="p-6 pt-16">
                                    ...
                                    <p className="mb-4 text-[var(--text-muted)]">{announcement.summary}</p>
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-[var(--text-muted)]">{announcement.date}</span>
                                        <a href="/announcements" className="inline-flex items-center text-sm text-[var(--info)] hover:underline">
                                            <span>Read More</span>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
