    ...
    <AppLayout>
      ...
      <div className="mx-auto max-w-3xl py-6">
        ...
        <div className="space-y-4 rounded-lg bg-white p-6 shadow">
          <p><span className="font-semibold">Full Name:</span> {child.name}</p>
          <p><span className="font-semibold">Sex:</span> {child.sex}</p>
          <p><span className="font-semibold">Age:</span> {child.age ?? 'N/A'}</p>
        ...
        <button
          className="fixed top-36 right-4 z-50 rounded bg-blue-600 px-4 py-2 text-white transition hover:bg-blue-700"
                ...
                >
                  <div>
                    ...
                    <small className="text-gray-500">
                      by {note.author?.name ?? note.user_name ?? 'Unknown'} on{' '}
