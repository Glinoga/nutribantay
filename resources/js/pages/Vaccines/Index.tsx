                    ...
                    {filteredVaccines.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            ...
                            <p className="text-lg font-medium text-gray-900 dark:text-gray-100">
                                {search ? 'No vaccines match your search.' : 'No vaccines yet'}
                            </p>
                                ...
                                <div key={vaccine.id} className="vaccine-card group" style={{ animationDelay: `${index * 50}ms` }}>
                                    <div className="h-full rounded-xl border-0 bg-white shadow-md transition-all hover:shadow-xl dark:bg-gray-800">
                                        <div className="p-4">
                                            ...
                                            {vaccine.description && (
                                                <p className="mb-3 line-clamp-2 text-xs text-gray-600 dark:text-gray-300">{vaccine.description}</p>
                                            )}
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            <Label htmlFor="vaccine-name" className="dark:text-gray-300">
                                Vaccine Name
                            </Label>
                            <Input
                                id="vaccine-name"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="vaccine-description" className="dark:text-gray-300">
