...
import { BookOpen, Database, Folder, HeartPulse, LayoutGrid, UserCog, UserPen } from 'lucide-react';
...
export function AppSidebar() {
    ...
    if (isAdmin) {
        ...
        mainNavItems.push({ title: 'Data Management', href: '/admin/database', icon: Database });
    }
